...
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0xxvvz") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'royal_filesvv') # Collection name (default: dreamcinezone_files)
